...
## Local fork integration (2026-09-24)
- Retain Combo `[1m]` resolution, native Claude thinking and client-version forwarding, and Gemini schema annotation cleanup.
- Reduce the GLM-5.2 local patch to effort-suffix lookup; use upstream's canonical 1M context / 131072 output limits.
